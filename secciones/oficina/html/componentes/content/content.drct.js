    ...
    angular
        ...
        .directive('cmsContenido', cmsContenido);

    /* @ngInject */
    function cmsContenido ($rootScope, $compile, $templateRequest) {
        // Usage:
        //
        // Creates:
        //
        ...
        function link($scope, $element) {
            ...
            $scope.$on('$routeChangeStart', scrollToTop);
            ...
            function injectFooterUpdateContent() {
                ...
                $templateRequest('secciones/oficina/html/componentes/footer/footer.tmpl.html')
