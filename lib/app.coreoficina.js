...
angular.module('app.coreoficina', ['ngMessages','ngMaterial','ngSanitize','angularMoment','textAngular','angularFileUpload', 'ngFileUpload', 'flow', 'ngImgCrop'])
.config(moduleConfig);

/* @ngInject */
function moduleConfig($routeProvider, triMenuProvider, flowFactoryProvider  ) {
