...
use Token\JWT\Signer\Ecdsa\KeyParser;
...
class EcdsaTest extends \PHPUnit_Framework_TestCase
{
     ...
     * @test
     *
     * @covers Token\JWT\Signer\Ecdsa::__construct
     */
     ...
     * @test
     *
     * @uses Token\JWT\Signer\Ecdsa::__construct
     * @uses Token\JWT\Signer\Key
     *
     * @covers Token\JWT\Signer\Ecdsa::createHash
     * @covers Token\JWT\Signer\Ecdsa::createSigningHash
     * @covers Token\JWT\Signer\Ecdsa::createSignatureHash
     */
     ...
     * @uses Token\JWT\Signer\Key
     *
     * @covers Token\JWT\Signer\Ecdsa::doVerify
     * @covers Token\JWT\Signer\Ecdsa::createSigningHash
     * @covers Token\JWT\Signer\Ecdsa::extractSignature
     */
