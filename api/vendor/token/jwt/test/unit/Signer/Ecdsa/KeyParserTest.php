...
class KeyParserTest extends \PHPUnit_Framework_TestCase
{
     ...
     * @test
     *
     * @covers Token\JWT\Signer\Ecdsa\KeyParser::__construct
     */
     ...
     * @test
     *
     * @uses Token\JWT\Signer\Ecdsa\KeyParser::__construct
     * @uses Token\JWT\Signer\Key
     *
     * @covers Token\JWT\Signer\Ecdsa\KeyParser::getPrivateKey
     * @covers Token\JWT\Signer\Ecdsa\KeyParser::getKeyContent
     */
     ...
     * @uses Token\JWT\Signer\Key
     *
     * @covers Token\JWT\Signer\Ecdsa\KeyParser::getPublicKey
     * @covers Token\JWT\Signer\Ecdsa\KeyParser::getKeyContent
     */
