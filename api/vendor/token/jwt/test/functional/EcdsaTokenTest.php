...
use Token\JWT\Signer\Ecdsa\Sha256;
use Token\JWT\Signer\Ecdsa\Sha512;
use Token\JWT\Signer\Keychain;
use Token\JWT\Keys;
...
class EcdsaTokenTest extends \PHPUnit_Framework_TestCase
{
     ...
     * @covers Token\JWT\Signer\Ecdsa
     * @covers Token\JWT\Signer\Ecdsa\KeyParser
     * @covers Token\JWT\Signer\Ecdsa\Sha256
     */
     ...
     * @covers Token\JWT\Signer\Ecdsa\KeyParser
     * @covers Token\JWT\Signer\Ecdsa\Sha256
     * @covers Token\JWT\Signer\Ecdsa\Sha512
     */
     ...
     * @covers Token\JWT\Signer\Ecdsa\KeyParser
     * @covers Token\JWT\Signer\Ecdsa\Sha512
     * @covers Token\JWT\Signer\Keychain
     * @covers Token\JWT\Claim\Factory
     * @covers Token\JWT\Claim\Basic
     * @covers Token\JWT\Parsing\Encoder
     * @covers Token\JWT\Parsing\Decoder
