...
abstract class JaPaginasQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, titulo, contenido, imagen, categoria, leermas, estado, tipo, autor, padre, slug, meta_descripcion, meta_palabras, meta_titulo, fecha_creado, fecha_modificado, configuracion FROM ja_paginas WHERE id = :p0';
        try {
